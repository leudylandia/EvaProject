...
{
    public class ProvinciaMVCController : Controller
    {
        private readonly IProvinciaService _provinciaService;
        private readonly IPaisService _paisService;

        public ProvinciaMVCController(IProvinciaService provinciaService, IPaisService paisService)
        {
        ...
        public IActionResult Create(ProvinciaViewModel model)
        {
            ...
            return RedirectToAction(nameof(Index), "ProvinciaMVC");
        }
